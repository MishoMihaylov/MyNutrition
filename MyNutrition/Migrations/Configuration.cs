...
namespace MyNutrition.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyNutrition.Models.MyNutritionDbContext>
    {
        ...
        protected override void Seed(MyNutrition.Models.MyNutritionDbContext context)
        {
            ...
            context.IngredientTypes.AddOrUpdate(new IngredientType[] { vegetables, protein, fruits, grains, dairy });
            context.SaveChanges();

            var bran = new Ingredient { Name = "bran", IngredientType = grains };
            var reisin = new Ingredient { Name = "reisin", IngredientType = fruits };
            var water = new Ingredient { Name = "water" };
            var butter = new Ingredient { Name = "butter", IngredientType = dairy };
            var sugar = new Ingredient { Name = "sugar" };
            var vegerableOil = new Ingredient { Name = "vegetable oil" };
            var egg = new Ingredient { Name = "egg" };
            var flour = new Ingredient { Name = "flour", IngredientType = grains };
            var bakingPowder = new Ingredient { Name = "baking powder" };
            context.Ingredients.AddOrUpdate(new Ingredient[] { bran, reisin, water, butter, sugar, vegerableOil, egg, flour, bakingPowder });
            context.SaveChanges();
            ...
            recipe.IngredientAmounts.Add(new IngredientAmount { IngredientId = 8, RecipeId = 1, Amount = 50 });
